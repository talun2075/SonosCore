...
namespace SonosUPnP.Props
{
    ...
    public class ZoneMethods
    {
        ...
        /// <returns></returns>
        public async Task<Boolean> CreateFavorite(SonosPlayer pl ,String objectID)
        {
        ...
        public async Task<Boolean> AddToQueue(string v, SonosPlayer pl)
        {
            if (pl == null) return false;
                ...
                {
                    {
                        ...
                        string rinconpl = SonosItemHelper.ContainertoURI(v, pl.UUID);
            ...
            try
            {
                foreach (SonosItem item in _list)
                {
                    ...
                    try
                    {
                        if (item.Uri != null)
                        {
                            string itemp = SonosItemHelper.URItoPath(item.Uri);
