...
namespace OSTL.UPnP
{
    ...
    {
        //todo: webrequest ersetzen durch httpclient. heißt einmal die ganze klasse.
        ...
        private void GetRequestAsyncCallback(IAsyncResult ar)
        {
            ...
            {
                PendingRequests--;
                OnRequestCompleted?.Invoke(this, false, r.tag, r.url, null);
                return;
            }
            r.request.BeginGetResponse(GetResponseAsyncCallback, r);
        }
        ...
        private void GetResponseAsyncCallback(IAsyncResult ar)
        {
            ...
            PendingRequests--;
            OnRequestCompleted?.Invoke(this, true, r.tag, r.url, buf);
        }
