...
namespace OSTL.UPnP
{
    ...
    public sealed class NetworkInfo
    {
        ...
        private readonly WeakEvent OnNewInterfaceEvent = new();
        private readonly WeakEvent OnInterfaceDisabledEvent = new();
        ...
        private readonly LifeTimeMonitor InterfacePoller = new();
        //private String HostName;
        private ArrayList AddressTable = new();
        ...
        private void PollInterface(LifeTimeMonitor sender, Object obj)
        {
            try
            {
                ArrayList CurrentAddressTable = new();
                NetworkInterface[] interfaces = NetworkInterface.GetAllNetworkInterfaces();
                foreach (NetworkInterface i in interfaces)
                {
                    if (i.IsReceiveOnly == false && i.OperationalStatus == OperationalStatus.Up && i.SupportsMulticast)
        ...
        static public int GetFreePort(int LowRange, int UpperRange, IPAddress OnThisIP)
        {
            ...
            int TestPort;
            IPEndPoint TestEP;
            Socket TestSocket = new(AddressFamily.InterNetwork, SocketType.Stream, ProtocolType.Tcp);
