...
namespace OSTL.UPnP
{
	...
	public class UPnPComplexType
	{
		...
		public class ItemCollection
		{
			...
			public ArrayList ItemList = new();
			public ArrayList NestedCollectionList = new();
		...
		public class GenericContainer
		{
			...
			public ArrayList CollectionList = new();
		...
		private readonly ArrayList m_CollectionList;
		...
		public static UPnPComplexType[] Parse(string xml)
		{
			...
			ArrayList a = new(); // ComplexTypes
			Hashtable g = new(); // Table of Groups
			StringReader s = new(xml);
			XmlTextReader X = new(s);
