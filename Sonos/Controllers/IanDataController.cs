...
namespace Sonos.Controllers
{
    ...
    [Route("/[controller]")]
    public class IanDataController : ChildBase
    {
        public IanDataController(ILogging log, ISonosHelper sh, ISonosDiscovery sonos, IMusicPictures imu) :base(log,sh,sonos,imu)
        {
            ChildName = "Ian";
            ReadConfiguration();
        }
